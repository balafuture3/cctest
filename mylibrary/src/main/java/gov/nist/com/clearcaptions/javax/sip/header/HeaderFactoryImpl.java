...
public class HeaderFactoryImpl implements HeaderFactory , HeaderFactoryExt {
	...
	*/
	...
	public ExtensionHeader createExtensionHeader(
		...
		ExtensionHeaderImpl ext =
			new ExtensionHeaderImpl();
		ext.setName(name);
		ext.setValue(value);
	...
	*/
	...
	/*
	 * (non-Javadoc)
	 * @see com.clearcaptions.javax.sip.header.HeaderFactory#createSIPETagHeader(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.clearcaptions.javax.sip.header.HeaderFactory#createSIPIfMatchHeader(java.lang.String)
	 */
	...
	public HeaderFactoryImpl() {
		stripAddressScopeZones
			= Boolean.getBoolean("gov.nist.com.clearcaptions.core.STRIP_ADDR_SCOPES");
	}
