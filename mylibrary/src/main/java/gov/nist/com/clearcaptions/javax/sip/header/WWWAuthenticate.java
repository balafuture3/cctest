...
import gov.nist.com.clearcaptions.javax.sip.header.ims.WWWAuthenticateHeaderIms;
...
public class WWWAuthenticate
	...
	/* (non-Javadoc)
	 * @see gov.nist.com.clearcaptions.javax.sip.header.AuthenticationHeader#getURI()
	 * 
	...
	/* (non-Javadoc)
	 * @see gov.nist.com.clearcaptions.javax.sip.header.AuthenticationHeader#setURI(com.clearcaptions.javax.sip.address.URI)
	 * 
	 * @since 1.2 this method is deprecated, uri is not a valid paramter for this header
	 * Fail silently for backwards compatibility 
	 */
