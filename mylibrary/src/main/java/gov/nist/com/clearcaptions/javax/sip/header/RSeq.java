 ...
 * 
 */
public class RSeq extends SIPHeader implements com.clearcaptions.javax.sip.header.RSeqHeader {
	/**
	...
	/**
	 * @deprecated 
	 * @see com.clearcaptions.javax.sip.header.RSeqHeader#setSequenceNumber(int)
	 */
