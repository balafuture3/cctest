...
package gov.nist.com.clearcaptions.javax.sip.parser;

import gov.nist.com.clearcaptions.core.Host;
import gov.nist.com.clearcaptions.core.HostNameParser;
import gov.nist.com.clearcaptions.javax.sip.SIPConstants;
import gov.nist.com.clearcaptions.javax.sip.address.AddressImpl;
import gov.nist.com.clearcaptions.javax.sip.address.GenericURI;
import gov.nist.com.clearcaptions.javax.sip.address.SipUri;
import gov.nist.com.clearcaptions.javax.sip.address.TelephoneNumber;
...
public class StringMsgParser {
	...
	*/
	...
	public static void main(String[] args) throws ParseException {
		...
		for (int i = 0; i < 20; i++) {
			new Thread(new ParserThread(messages), "StringMsgParser").start();
		}
