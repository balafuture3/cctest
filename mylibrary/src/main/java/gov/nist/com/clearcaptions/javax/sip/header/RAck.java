 ...
 * 
 */
public class RAck extends SIPHeader implements com.clearcaptions.javax.sip.header.RAckHeader {
	...
	/**
	 * @deprecated
	 * @see com.clearcaptions.javax.sip.header.RAckHeader#setCSeqNumber(int)
	 */
	...
	/**
	 *@deprecated
	 * @see com.clearcaptions.javax.sip.header.RAckHeader#setRSeqNumber(int)
	 */
