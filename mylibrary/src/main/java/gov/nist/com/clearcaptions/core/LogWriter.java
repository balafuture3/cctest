...
public class LogWriter {
	...
	public LogWriter(Properties configurationProperties) {
		...
		String logLevel = configurationProperties
				.getProperty("gov.nist.com.clearcaptions.javax.sip.TRACE_LEVEL");

		this.logFileName = configurationProperties
				.getProperty("gov.nist.com.clearcaptions.javax.sip.DEBUG_LOG");

		this.stackName = configurationProperties
				.getProperty("com.clearcaptions.javax.sip.STACK_NAME");
		...
		String category = configurationProperties
								.getProperty("gov.nist.com.clearcaptions.javax.sip.LOG4J_LOGGER_NAME", this.stackName);
				...
				if (this.needsLogging && this.logFileName != null) {
					...
					boolean overwrite = Boolean.valueOf(
						configurationProperties.getProperty(
								"gov.nist.com.clearcaptions.javax.sip.DEBUG_LOG_OVERWRITE"));
