 ...
 * @version 1.2
 * @since 1.2
 * @see SipStackImpl#setAddressResolver(AddressResolver)
 * 
...
public class DefaultAddressResolver implements AddressResolver {
	...
	/*
	 * (non-Javadoc)
	 * @see gov.nist.com.clearcaptions.core.net.AddressResolver#resolveAddress(com.clearcaptions.javax.sip.address.Hop)
	 */
