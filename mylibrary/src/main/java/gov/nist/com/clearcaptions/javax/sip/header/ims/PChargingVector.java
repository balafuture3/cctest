...
package gov.nist.com.clearcaptions.javax.sip.header.ims;

import java.text.ParseException;

import com.clearcaptions.javax.sip.header.ExtensionHeader;
...
public class PChargingVector extends gov.nist.com.clearcaptions.javax.sip.header.ParametersHeader
	 ...
	 * (non-Javadoc)
	 * 
	 * @see gov.nist.com.clearcaptions.javax.sip.header.ParametersHeader#encodeBody()
	 */
	protected String encodeBody() {
		 ...
		 */		
		gov.nist.com.clearcaptions.core.NameValue nv = getNameValue( ParameterNamesIms.ICID_VALUE );
		nv.encode( encoding );
