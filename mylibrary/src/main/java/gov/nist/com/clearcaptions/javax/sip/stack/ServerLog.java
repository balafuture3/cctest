...
import gov.nist.com.clearcaptions.javax.sip.LogRecord;
...
public class ServerLog {
	...
	private void setProperties(Properties configurationProperties) {
		...
		this.description = configurationProperties.getProperty("com.clearcaptions.javax.sip.STACK_NAME");
		this.stackIpAddress = configurationProperties.getProperty("com.clearcaptions.javax.sip.IP_ADDRESS");
		this.logFileName = configurationProperties.getProperty("gov.nist.com.clearcaptions.javax.sip.SERVER_LOG");
		String logLevel = configurationProperties.getProperty("gov.nist.com.clearcaptions.javax.sip.TRACE_LEVEL");
		String logContent = configurationProperties
				.getProperty("gov.nist.com.clearcaptions.javax.sip.LOG_MESSAGE_CONTENT");
		...
		if (logLevel != null) {
			if (logLevel.equals("LOG4J")) {
				...
				Logger logger = Logger.getLogger(configurationProperties.getProperty(
						"gov.nist.com.clearcaptions.javax.sip.LOG4J_LOGGER_NAME", this.description));
			...
			if (printWriter == null) {
				boolean overwrite = Boolean.valueOf(
					configurationProperties.getProperty(
						"gov.nist.com.clearcaptions.javax.sip.SERVER_LOG_OVERWRITE"));
				...
				printWriter.println("<!-- "
						...
						+ "com.clearcaptions.javax.sip.IP_ADDRESS= "
						+ configurationProperties.getProperty("com.clearcaptions.javax.sip.IP_ADDRESS") + "\n"
						+ "com.clearcaptions.javax.sip.STACK_NAME= "
						+ configurationProperties.getProperty("com.clearcaptions.javax.sip.STACK_NAME") + "\n"
						+ "com.clearcaptions.javax.sip.ROUTER_PATH= "
						+ configurationProperties.getProperty("com.clearcaptions.javax.sip.ROUTER_PATH") + "\n"
						+ "com.clearcaptions.javax.sip.OUTBOUND_PROXY= "
						+ configurationProperties.getProperty("com.clearcaptions.javax.sip.OUTBOUND_PROXY") + "\n"
						+ "-->");
						...
						logWriter
								.logDebug("Here are the stack configuration properties \n"
										...
										+ configurationProperties
												.getProperty("com.clearcaptions.javax.sip.IP_ADDRESS")
										+ "\n"
										+ "com.clearcaptions.javax.sip.ROUTER_PATH= "
										+ configurationProperties
												.getProperty("com.clearcaptions.javax.sip.ROUTER_PATH")
										+ "\n"
										+ "com.clearcaptions.javax.sip.OUTBOUND_PROXY= "
										+ configurationProperties
												.getProperty("com.clearcaptions.javax.sip.OUTBOUND_PROXY")
										+ "\n"
										+ "gov.nist.com.clearcaptions.javax.sip.CACHE_CLIENT_CONNECTIONS= "
										+ configurationProperties
												.getProperty("gov.nist.com.clearcaptions.javax.sip.CACHE_CLIENT_CONNECTIONS")
										+ "\n"
										+ "gov.nist.com.clearcaptions.javax.sip.CACHE_SERVER_CONNECTIONS= "
										+ configurationProperties
												.getProperty("gov.nist.com.clearcaptions.javax.sip.CACHE_SERVER_CONNECTIONS")
										+ "\n"
										+ "gov.nist.com.clearcaptions.javax.sip.REENTRANT_LISTENER= "
										+ configurationProperties
												.getProperty("gov.nist.com.clearcaptions.javax.sip.REENTRANT_LISTENER")
										+ "gov.nist.com.clearcaptions.javax.sip.THREAD_POOL_SIZE= "
										+ configurationProperties
