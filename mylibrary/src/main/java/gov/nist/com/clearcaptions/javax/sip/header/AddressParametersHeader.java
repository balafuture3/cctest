...
import com.clearcaptions.javax.sip.header.HeaderAddress;
import com.clearcaptions.javax.sip.header.Parameters;
...
public abstract class AddressParametersHeader extends ParametersHeader implements  Parameters {
	...
	/* (non-Javadoc)
	 * @see gov.nist.com.clearcaptions.javax.sip.header.AddressParameters#getAddress()
	 */
	...
	/* (non-Javadoc)
	 * @see gov.nist.com.clearcaptions.javax.sip.header.AddressParameters#setAddress(com.clearcaptions.javax.sip.address.Address)
	 */
	...
	/* (non-Javadoc)
	 * @see gov.nist.com.clearcaptions.javax.sip.header.AddressParameters#clone()
	 */
	public Object clone() {
	...
	/* (non-Javadoc)
	 * @see gov.nist.com.clearcaptions.javax.sip.header.AddressParameters#equals(java.lang.Object)
	 */
