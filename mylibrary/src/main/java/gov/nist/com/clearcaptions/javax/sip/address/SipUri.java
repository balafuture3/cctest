...
*******************************************************************************/
package gov.nist.com.clearcaptions.javax.sip.address;
...
public class SipUri extends GenericURI implements SipURI , SipURIExt{
	...
	private static Logger logger = LoggerFactory.getLogger(SipUri.class);
	...
	public boolean equals(Object that) {
		...
		if (that instanceof SipURI) {
			...
			if(a.getHeaderNames().hasNext() && b.getHeaderNames().hasNext()) {
				...
				try {
					headerFactory = new SipFactory().createHeaderFactory();
	...
	*/
	 ...
	 * are defined in the {@link com.clearcaptions.javax.sip.ListeningPoint}.
	 *
	 * @param transport - new value for the "transport" parameter
	 * @see com.clearcaptions.javax.sip.ListeningPoint
	 */
