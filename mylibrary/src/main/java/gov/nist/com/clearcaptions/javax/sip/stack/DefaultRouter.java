 ...
 * 
 * <p>
 * When <code>com.clearcaptions.javax.sip.USE_ROUTER_FOR_ALL_URIS</code> is set to
 ...
 * <li> Else, if the property <code>com.clearcaptions.javax.sip.OUTBOUND_PROXY</code> is set,
 * use its value as the next hop
 * <li> Otherwise, use the request URI as next hop. If the request URI is not a
 * SIP URI, call {@link Router#getNextHop(Request)} provided
 * by the application.
 * </ul>
 * 
 * <p>
...
public class DefaultRouter implements Router {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.clearcaptions.javax.sip.address.Router#getNextHop(com.clearcaptions.javax.sip.message.Request)
	 */
