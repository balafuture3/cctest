...
import gov.nist.com.clearcaptions.javax.sdp.MediaDescriptionImpl;
import gov.nist.com.clearcaptions.javax.sdp.fields.AttributeField;
import gov.nist.com.clearcaptions.javax.sdp.fields.ConnectionField;
import gov.nist.com.clearcaptions.javax.sdp.fields.MediaField;
import gov.nist.com.clearcaptions.javax.sdp.fields.OriginField;
import gov.nist.com.clearcaptions.javax.sdp.fields.SDPKeywords;
import gov.nist.com.clearcaptions.javax.sdp.fields.SessionNameField;
...
import com.clearcaptions.javax.sdp.Attribute;
import com.clearcaptions.javax.sdp.MediaDescription;
...
import com.clearcaptions.javax.sip.SipFactory;
...
import com.clearcaptions.javax.sip.address.AddressFactory;
import com.clearcaptions.javax.sip.address.SipURI;
import com.clearcaptions.javax.sip.message.Message;
import com.clearcaptions.javax.sip.message.MessageFactory;
...
public class SipMessageHandler {
	...
	private String userAgentString = "dummyUserAgent";
	...
	private SipMessageHandler(LocalSipProfile localSipProfile, String localIPAddress, int localSipPort) throws PeerUnavailableException, TransportNotSupportedException,
		...
		properties.setProperty("com.clearcaptions.javax.sip.STACK_NAME", "ccsip");
		...
		while (!successfullyBound) {
			try {
				listeningPoint = sipStack.createListeningPoint(localIPAddress, localSipPort, ListeningPoint.TCP);
	...
	public void register(SipRequestState state) throws ParseException, InvalidArgumentException, SipException {
		...
		CCLog.debug(TAG, "in register(), " + request.getHeaderNames());
	...
	public void sendInvite(SipContact contact, SipRequestState state) throws ParseException, InvalidArgumentException, NullPointerException, SipException, SdpException {
		...
		// Create UserAgent header
		UserAgent userAgent = new UserAgent(); // gov.nist.com.clearcaptions.javax.sip.header.UserAgent;
		userAgent.addProductToken(userAgentString);
		request.addHeader(userAgent);
		CCLog.info(TAG, "SipMessageHandler userAgent: " + userAgent.toString());
	...
	public void reset() {
		...
		sipMessageHandler = null;
		callSequence = 1L;
	}

	public void setUserAgent(String userAgent) {
		//CCLog.info(TAG, "SipMessageHandler setUserAgent from " + userAgentString + " to " + userAgent);
