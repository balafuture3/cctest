 ...
 * File Name     : SipFactory.main.java
...
package com.clearcaptions.javax.sip;
 ...
 * <code>com.clearcaptions.javax.sip.SipStack</code> interface <B>must</B> be
 * <code>com.clearcaptions.javax.sip.SipStackImpl</code>.
 * </ul>
 * 
 ...
 * <code>gov.nist.com.clearcaptions.javax.sip.SipStackImpl.main.java</code> Because the space of
 ...
 * located at <code>com.bea.javax.sip.SipStackImpl.main.java</code>.
 * <p>
...
public class SipFactory {
	...
	public static synchronized SipFactory getInstance() {
       ...
       * "com.clearcaptions.javax.sip.IP_ADDRESS" property in the Properties argument, in this 
       * case the "com.clearcaptions.javax.sip.STACK_NAME" uniquely identifies the stack. 
       ...
       * For backwards compatability, if a "com.clearcaptions.javax.sip.IP_ADDRESS" is supplied, 
	...
	public synchronized SipStack createSipStack(Properties properties)
		...
		String ipAddress = properties.getProperty("com.clearcaptions.javax.sip.IP_ADDRESS");
		String name = properties.getProperty("com.clearcaptions.javax.sip.STACK_NAME");
		if (name == null ) throw new PeerUnavailableException("Missing com.clearcaptions.javax.sip.STACK_NAME property");
	...
	public MessageFactory createMessageFactory()
		...
		if (messageFactory == null) {
			messageFactory = (MessageFactory) createSipFactory("com.clearcaptions.javax.sip.message.MessageFactoryImpl");
		}
	...
	public HeaderFactory createHeaderFactory() throws PeerUnavailableException {
		if (headerFactory == null) {
			headerFactory = (HeaderFactory) createSipFactory("com.clearcaptions.javax.sip.header.HeaderFactoryImpl");
		}
	...
	public AddressFactory createAddressFactory()
		...
		if (addressFactory == null) {
			addressFactory = (AddressFactory) createSipFactory("com.clearcaptions.javax.sip.address.AddressFactoryImpl");
		}
	...
	private SipStack createStack(Properties properties)
		...
		try {
			...
			Constructor sipStackConstructor = Class.forName(
					getPathName() + ".com.clearcaptions.javax.sip.SipStackImpl").getConstructor(
					paramTypes);
			...
			String errmsg = "The Peer SIP Stack: "
					+ getPathName()
					+ ".com.clearcaptions.javax.sip.SipStackImpl"
					+ " could not be instantiated. Ensure the Path Name has been set.";
			throw new PeerUnavailableException(errmsg, e);
		}
	}
