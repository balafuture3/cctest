 ...
 * File Name     : SipListener.main.java
 ...
 * An application can send messages by passing {@link com.clearcaptions.javax.sip.message.Request}
 * and {@link com.clearcaptions.javax.sip.message.Response}messages to that the following object:
 * <ul>
 * <li>Request and response messages can be sent statelessly via the
 * SipProvider using the send methods on the {@link SipProvider}.
